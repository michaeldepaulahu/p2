<?php 
	// adds generate password class
	require('logic.php');
	
	// initiate class and number input session
	$process = new GenProc1('words');
	$process->session('nW', 'words'); 
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="row thumb1 text-center">
                <div class="col-lg-12 hidden-xs">
                    <p class="title">xkcd Password Generator</p>
						<form method='POST' action='index.php' class="form-inline hidden-xs">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="mobile1">
                        <div class="nav navbar-nav">
							<form method='POST' action='index.php' class="form-mobile visible-xs">
